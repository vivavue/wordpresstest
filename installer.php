...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210131_testnew_86426a9fd254f2e79992_20210131201624_archive.zip';
	const ARCHIVE_SIZE		 = '76816078';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '86426a9-31201624';
    const SECONDARY_PACKAGE_HASH = 'b47c3af-31201624';
	const VERSION			 = '1.3.40.1';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.40.1==');
		self::log('----------------------------------------------------');
